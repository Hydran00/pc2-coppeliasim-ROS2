...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('input_topic', default_value='/Float32MultiArray_in'),
        ...
        DeclareLaunchArgument('view_angle', default_value='57'),
        ...
        Node(
            ...
            executable='pc2_coppeliasim',
            name='pc2_coppeliasim',
            output='screen',
            parameters=[
